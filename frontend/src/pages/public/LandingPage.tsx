...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-800 flex flex-col font-sans overflow-x-hidden selection:bg-blue-600 selection:text-white">
      ...
      <nav className="sticky top-0 bg-white/80 backdrop-blur-xl border-b border-slate-200/50 px-6 py-3.5 flex items-center justify-between z-50 transition-all duration-300">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold text-slate-600 hover:text-blue-600 hover:bg-slate-100/50 rounded-lg transition-all cursor-pointer"
          >
            Login
          </button>
          <button
            onClick={() => navigate('/apply')}
            className="px-3 sm:px-4.5 py-2 text-xs sm:text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-xl transition-all shadow-md shadow-blue-500/10 flex items-center gap-1.5 cursor-pointer whitespace-nowrap"
          >
      ...
      <section className="relative px-6 pt-16 pb-8 md:pt-20 md:pb-12 max-w-6xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-left flex flex-col items-start animate-[heroFadeIn_0.8s_ease-out_0.2s_both]">
            ...
            {/* Trusted By Strip */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 text-xs text-slate-400 font-medium">
          ...
          <div className="relative animate-[heroFadeIn_0.8s_ease-out_0.5s_both] pb-4 sm:pb-0">
            ...
            <div className="absolute -bottom-3 left-2 sm:-left-3 bg-blue-600 text-white text-[10px] font-bold px-3 py-1.5 rounded-lg shadow-lg shadow-blue-500/20 flex items-center gap-1.5 animate-[floatBadge_3s_ease-in-out_infinite]">
      ...
      {/* ═══════════ Features ═══════════ */}
      <section id="features" className="px-6 py-10 sm:py-20 max-w-5xl mx-auto space-y-8 sm:space-y-14">
        <div className="text-center max-w-2xl mx-auto space-y-3 sm:space-y-4 animate-[slideUpFadeIn_1s_cubic-bezier(0.16,1,0.3,1)_both]">
          <SectionBadge text="Core Features" />
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">Everything your team needs, nothing it doesn't</h2>
      ...
      {/* ═══════════ How it Works ═══════════ */}
      <section id="workflow" className="py-10 sm:py-20 px-6">
        <div className="max-w-5xl mx-auto space-y-10 sm:space-y-16">
          <div className="text-center max-w-2xl mx-auto space-y-4">
            <SectionBadge text="Simple Workflow" />
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">From application to certification in three steps</h2>
      ...
      {/* ═══════════ Testimonials ═══════════ */}
      <section id="testimonials" className="bg-white border-y border-slate-200/50 px-6 py-10 sm:py-20">
        <div className="max-w-5xl mx-auto space-y-8 sm:space-y-14">
          <div className="text-center max-w-2xl mx-auto space-y-4">
            <SectionBadge text="Testimonials" />
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-slate-900 tracking-tight">Trusted by HR teams and interns alike</h2>
      ...
      {/* ═══════════ CTA Banner ═══════════ */}
      <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 py-10 sm:py-16 px-5 sm:px-6 text-center text-white relative overflow-hidden">
      ...
      <footer className="bg-slate-900 border-t border-slate-800 px-6 py-16 text-slate-400">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-10 mb-12 text-left">
